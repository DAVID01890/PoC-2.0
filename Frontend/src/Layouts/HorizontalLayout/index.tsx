    ...
    useEffect(() => {
        ...
        const initMenu = () => {
            ...
            let matchingMenuItem = itemsArray.find((x) => {
                ...
                const cleanX = x.pathname.replace(/\/$/, "");
                ...
                // Normalize project sub-paths like stories or sprints to backlog
                const projectSubPathMatch = cleanPath.match(/^\/projects\/([^\/]+)\/(stories|sprints)/);
                if (projectSubPathMatch) {
                    cleanPath = `/projects/${projectSubPathMatch[1]}/backlog`;
                }

                return cleanPath === cleanX || cleanX === `${cleanPath}/backlog`;
            });
            if (matchingMenuItem) {
